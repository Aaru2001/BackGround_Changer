...
function App() {
  ...
  return (
    ...
    style={{backgroundColor:color}}>
      ...
      <h1 className="text-3xl font-bold flex justify-center items-center h-screen text-white">BackGround Changer</h1>

      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">

        <div className="flex flex-wrap justify-items-center gap-3 bg-white px-3 py-2 rounded-3xl">
